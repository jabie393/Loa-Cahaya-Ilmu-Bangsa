...
<body class="bg-surface font-body text-on-surface selection:bg-primary/20 antialiased">
    <!-- TopNavBar -->
    <nav
        class="fixed top-0 z-50 w-full bg-white/20 shadow-[0_20px_40px_rgba(0,74,198,0.05)] backdrop-blur-xl dark:bg-slate-950/80">
        <div class="mx-auto flex w-full max-w-7xl items-center justify-between px-8 py-4">
            ...
            <div
                class="font-headline hidden items-center gap-8 text-sm font-medium tracking-tight transition duration-150 ease-in-out md:flex">
    ...
    <main>
        <!-- Hero Section -->
        <section class="relative bg-cover bg-fixed bg-bottom bg-no-repeat"
            style="background-image: url('{{ asset('assets/bg.jpg') }}');">
            <!-- Overlay for better contrast -->
            <div class="absolute inset-0 bg-white/30 backdrop-blur-[2px]"></div>

            <div
                class="relative mx-auto flex w-full max-w-7xl flex-col items-center justify-center px-8 py-32 text-center md:py-48 lg:w-3/5">
                <div
                    class="border-primary/20 mb-6 flex items-center gap-2 rounded-full border bg-white/80 px-4 py-1.5 shadow-sm">
                    <span class="bg-primary flex h-2 w-2 rounded-full"></span>
                    <span class="font-headline text-primary text-xs font-bold uppercase tracking-widest">Service
                        Editorial Profesional</span>
                </div>

                <h1
                    class="font-headline mb-6 text-5xl font-extrabold leading-tight tracking-tighter text-slate-900 md:text-7xl">
                ...
                <p class="mb-10 max-w-xl text-lg font-medium leading-relaxed text-slate-700 md:text-xl">
                    Sistem kurasi digital resmi untuk mempermudah perolehan <strong>Letter of Acceptance (LOA)</strong>
                    bagi civitas akademika dengan standar jurnal bereputasi.
                </p>
        ...
        <section class="bg-surface-container-low/50 animate-reveal py-24" id="guide">
            ...
            <div class="mx-auto max-w-7xl px-8">
                <div class="mx-auto mb-16 max-w-2xl text-center">
                    <h2 class="font-headline text-on-surface mb-4 text-4xl font-bold tracking-tight">Alur Proses Kurasi
                    </h2>
                    <p class="text-on-surface-variant">Ikuti langkah-langkah terukur untuk mendapatkan sertifikasi resmi
                        dari tim editorial kami.</p>
                </div>

                <div class="grid grid-cols-1 gap-4 md:grid-cols-4 md:gap-0">
                    <!-- Step 1 -->
                    <div
                        class="bg-surface-container-lowest group relative flex flex-col items-center rounded-2xl p-8 text-center md:rounded-none md:bg-transparent">
                        <div
                        ...
                        <p class="text-on-surface-variant text-sm leading-relaxed">Buat akun untuk masuk ke dashboard
                            digital dan mengelola profil peneliti Anda.</p>
                    ...
                    <div
                        ...
                        <p class="text-on-surface-variant text-sm leading-relaxed">Lengkapi detail naskah dan lampirkan
                            bukti pembayaran dalam satu form praktis.</p>
                        <div class="bg-primary/5 mt-4 rounded-full p-3">
                    ...
                    <div
                        ...
                        <p class="text-on-surface-variant text-sm leading-relaxed">Tim ahli kami melakukan kurasi naskah
                            dan validasi administrasi secara profesional.</p>
                        <div class="bg-primary/5 mt-4 rounded-full p-3">
                    ...
                    <div
                        ...
                        <p class="text-on-surface-variant text-sm leading-relaxed">Terima paket lengkap: LOA, Author
                            Certificate, dan Plagiarism-Free Certificate.</p>
                ...
                <div
                    ...
                    <div
                        class="flex min-w-[220px] flex-col items-stretch gap-3 rounded-2xl bg-white/30 px-6 py-5 backdrop-blur-md">
                        <a href="/assets/panduan.pdf" target="_blank"
    ...
    <footer class="mt-20 w-full rounded-t-[1.5rem] bg-slate-50 dark:bg-slate-900">
        <div
            class="mx-auto flex w-full max-w-7xl flex-col items-center justify-between gap-8 px-12 py-16 md:flex-row md:items-end">
            <div class="flex flex-col gap-4 text-center md:text-left">
                <div class="font-headline text-lg font-black text-slate-900 dark:text-white">LOA</div>
                <p class="font-body text-xs font-semibold uppercase tracking-widest text-slate-500">© 2026 Cahaya Ilmu
                    Bangsa.</p>
            </div>
            <div class="flex flex-col gap-4 text-center md:text-right">
                <p class="font-body text-xs font-semibold uppercase tracking-widest text-slate-500">Developed by <a
                        href="https://instagram.com/ryudevs">RyuDevs</a></p>
            </div>
        </div>
    </footer>
</body>
