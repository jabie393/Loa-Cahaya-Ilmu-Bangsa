...
@foreach($pages as $pageIndex => $pageAuthors)
    <div class="loa-appendix-page" style="box-sizing: border-box; background: white; width: 210mm; height: 297mm; max-height: 297mm; overflow: hidden; padding: 36pt 54pt 36pt 54pt; position: relative; font-family: 'Calibri', 'Bahnschrift', sans-serif; margin: 0 auto; page-break-before: always; page-break-inside: avoid; clear: both;">
        <div class="border-b-4 border-double border-[#1d428a] pb-3 mb-4">
        ...
        @if($pageIndex === 0)
            <table style="width: 100%; border-collapse: collapse; border: none; font-size: 10pt; line-height: 1.4 !important; margin-bottom: 12px;">
                <tr style="border: none;">
                    <td style="width: 120px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.4 !important;">Nomor LOA</td>
                    ...
                    <td style="border: none; padding: 2px 0; vertical-align: top; color: #374151; line-height: 1.4 !important;">{{ $record->loa_number }}</td>
                </tr>
                <tr style="border: none;">
                    <td style="width: 120px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.4 !important;">Judul Artikel</td>
                    <td style="width: 15px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; text-align: center; line-height: 1.4 !important;">:</td>
                ...
                <tr style="border: none;">
                    <td style="width: 120px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.4 !important;">Jurnal</td>
                    <td style="width: 15px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; text-align: center; line-height: 1.4 !important;">:</td>
        ...
        @else
            <table style="width: 100%; border-collapse: collapse; border: none; font-size: 10pt; line-height: 1.4 !important; margin-bottom: 12px;">
                <tr style="border: none;">
                    <td style="width: 120px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.4 !important;">Nomor LOA</td>
                    <td style="width: 15px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; text-align: center; line-height: 1.4 !important;">:</td>
                    <td style="border: none; padding: 2px 0; vertical-align: top; color: #374151; line-height: 1.4 !important;">{{ $record->loa_number }} (Lanjutan)</td>
                </tr>
                <tr style="border: none;">
                    <td style="width: 120px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.4 !important;">Judul Artikel</td>
                    <td style="width: 15px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; text-align: center; line-height: 1.4 !important;">:</td>
