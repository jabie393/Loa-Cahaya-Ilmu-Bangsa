                ...
                <div
                    ...
                    <div class="space-y-4 text-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4 pt-3 border-t border-gray-100 dark:border-gray-800">
                            ...
                            <div>
                                <span class="text-xs text-gray-500 dark:text-gray-400 block mb-0.5">Status DOI Saat
                                    Ini:</span>
                        ...
                        <div
                            class="pt-3 border-t border-gray-100 dark:border-gray-800 text-xs text-gray-600 dark:text-gray-400 leading-relaxed bg-blue-50/50 dark:bg-blue-950/20 p-3 rounded-lg border border-emerald-100 dark:border-blue-800/40">
                            <strong>Manfaat Tambah DOI:</strong> Artikel Anda akan mendapatkan link permanen resmi
                            Repository Identifier, memudahkan sitasi di Google Scholar, dan otomatis disinkronkan ke OJS
                            & database repository.
                        </div>
                    </div>
                </div>
                    ...
                    <template x-if="status === 'paid'">
                        <div class="py-6 space-y-4">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 max-w-xs mx-auto">
                                Pembayaran terverifikasi. Pengenal DOI Repository Identifier telah dibuat dan
                                disinkronkan.
                            </p>
                            <template x-if="doiIdentifier">
                                <div
                                    class="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/60 rounded-xl p-3 text-xs text-blue-800 dark:text-blue-300 space-y-1">
                                    <span
