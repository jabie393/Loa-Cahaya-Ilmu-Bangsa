...
@foreach($pages as $pageIndex => $pageAuthors)
    <div class="pfc-appendix-page" style="box-sizing: border-box; background: white; width: 210mm; height: 297mm; max-height: 297mm; overflow: hidden; padding: 50pt 72pt 72pt 72pt; position: relative; font-family: 'Calibri', 'Bahnschrift', sans-serif; margin: 0 auto; page-break-before: always; page-break-inside: avoid; clear: both;">
        <div class="border-b-4 border-double border-[#1a365d] pb-4 mb-6">
        ...
        @if($pageIndex === 0)
            <table style="width: 100%; border-collapse: collapse; border: none; font-size: 11pt; line-height: 1.6 !important; margin-bottom: 20px;">
                <tr style="border: none;">
                    ...
                    <td style="border: none; padding: 2px 0; vertical-align: top; color: #374151; line-height: 1.6 !important;">{{ $record->created_at->format('Y') }}/CIB{{ sprintf('%03d', $record->journal->id) }}/PFC{{ sprintf('%03d', $record->id) }}</td>
                </tr>
                <tr style="border: none;">
        ...
        @else
            <table style="width: 100%; border-collapse: collapse; border: none; font-size: 11pt; line-height: 1.6 !important; margin-bottom: 20px;">
                <tr style="border: none;">
                    <td style="width: 150px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.6 !important;">Nomor Sertifikat</td>
                    <td style="width: 15px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; text-align: center; line-height: 1.6 !important;">:</td>
                    <td style="border: none; padding: 2px 0; vertical-align: top; color: #374151; line-height: 1.6 !important;">{{ $record->created_at->format('Y') }}/CIB{{ sprintf('%03d', $record->journal->id) }}/PFC{{ sprintf('%03d', $record->id) }} (Lanjutan)</td>
                </tr>
                <tr style="border: none;">
                    <td style="width: 150px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; line-height: 1.6 !important;">Judul Artikel</td>
                    <td style="width: 15px; font-weight: bold; border: none; padding: 2px 0; vertical-align: top; text-align: center; line-height: 1.6 !important;">:</td>
        ...
        <div style="margin-top: 10px;">
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #d1d5db; font-size: 10pt;">
                <thead>
                    <tr style="background-color: #f3f4f6; color: #374151; height: 38px;">
                ...
                <tbody>
                    ...
                    @foreach($pageAuthors as $authorKey => $author)
                        <tr style="border-bottom: 1px solid #e5e7eb; height: 38px;">
