...
<div class="max-h-[70vh] sm:max-h-[76vh] overflow-y-auto custom-scrollbar pr-1 -mr-1">
    <div class="space-y-3 text-xs">
        <div class="text-center p-3 sm:p-3.5 bg-gray-50 dark:bg-gray-800/60 rounded-xl border border-gray-200 dark:border-gray-700">
            <span class="text-[10px] uppercase font-bold text-gray-400">Bukti Mutasi Pembayaran Developer</span>
            <div class="text-base sm:text-lg font-mono font-black text-primary-600 dark:text-primary-400 mt-0.5">
                {{ $record->payout_no }}
            </div>
            <div class="text-xl sm:text-2xl font-black font-mono text-emerald-700 dark:text-emerald-300 mt-1.5">
        ...
        <div class="p-3 sm:p-3.5 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 space-y-2 font-mono">
            ...
            <div class="flex justify-between {{ $record->rejection_reason ? 'border-b border-gray-100 dark:border-gray-800 pb-1.5' : '' }}">
        ...
        @if($record->proof_file)
            <div class="p-2.5 sm:p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl flex items-center justify-between">
