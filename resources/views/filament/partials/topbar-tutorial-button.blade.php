<div x-data="{ 
    ...
    <template x-teleport="body">
        ...
        >
            ...
            >
                <!-- Modal Header -->
                <div class="relative z-10 flex items-center justify-between border-b border-slate-100 dark:border-slate-800/80 px-5 py-3 sm:px-6 sm:py-3.5 flex-shrink-0 bg-slate-50/60 dark:bg-slate-800/40">
                    <div class="flex items-center gap-3">
                        <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 shadow-xs shrink-0">
                ...
                <div class="relative z-10 flex-1 min-h-0 flex items-center justify-center p-3 sm:p-5 bg-black/5 dark:bg-black/30 overflow-hidden">
                    <div class="relative w-full aspect-video rounded-xl overflow-hidden shadow-inner bg-black flex items-center justify-center mx-auto">
                ...
                <!-- Modal Footer -->
                <div class="relative z-10 flex items-center justify-between px-5 py-3 sm:px-6 sm:py-3.5 border-t border-slate-100 dark:border-slate-800/80 bg-slate-50/60 dark:bg-slate-800/40 text-xs text-slate-500 dark:text-slate-400 flex-shrink-0">
