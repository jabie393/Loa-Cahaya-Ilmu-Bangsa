<div class="flex items-center justify-center sm:justify-start gap-2 px-1 py-2 sm:mr-auto transition-opacity w-full sm:w-auto">
    ...
    <style>
        @media (max-width: 640px) {
            ...
            .fi-ta-header-toolbar .fi-ta-search-container {
                width: 100% !important;
            }
            .fi-ta-header-toolbar .fi-ta-search-container > div {
                width: 100% !important;
            }
        }
    </style>
