...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:wght@400;700&amp;family=Great+Vibes&amp;family=Montserrat:wght@300;400&amp;display=swap"
        rel="stylesheet" />
...
<body
    class="mx-auto my-[25mm] box-border h-[297mm] max-h-[297mm] w-[210mm] bg-white font-sans shadow-[0_0_10px_rgba(0,0,0,0.2)] print:m-0 print:shadow-none">
    ...
    <main class="print-a4 relative flex h-full flex-col items-center px-[72pt] pb-[72pt] pt-[105.8pt]"
        ...
        <div class="decorative-band top-0" data-purpose="header-graphics">
            <svg class="absolute left-0 top-0 h-full w-full" preserveAspectRatio="none" viewBox="0 0 800 100">
                <path d="M0 0 H800 V60 Q600 90 400 40 Q200 -10 0 70 Z" fill="#1a365d"></path>
                <path d="M0 0 H800 V40 Q600 70 400 20 Q200 -30 0 50 Z" fill="#2d3748" opacity="0.3"></path>
            </svg>
            <div
                class="bg-cert-gold absolute left-1/2 top-1/2 z-20 h-14 w-14 -translate-x-1/2 -translate-y-1/2 rotate-45 transform border-4 border-white shadow-lg">
            </div>
        </div>
        ...
        <section class="relative z-10 flex flex-col items-center justify-center text-center"
            ...
            <div class="mb-10">
                ...
                <p class="mt-4 font-serif text-sm tracking-widest">
                    No :
                    {{ $record->created_at->format('Y') }}/CIB{{ sprintf('%03d', $record->journal->id) }}/PFC{{ sprintf('%03d', $record->id) }}
                </p>
            </div>
            ...
            <div class="mx-auto max-w-lg space-y-8">
                <p class="text-justify font-serif text-base italic leading-relaxed text-gray-700">
                    Kepadanya diberikan predikat <span class="font-bold">Sangat Baik</span> dengan Plagiarisme dibawah
                    20%. Sertifikat ini berlaku jika dilengkapi dengan LoA. Demikian untuk dipergunakan sebagaimana
                    mestinya, dan akan diperbaiki jika terdapat kekeliruan.
                </p>
            </div>
        </section>

        <div class="relative z-10 mt-12 flex w-full justify-center px-16" data-purpose="signatures">
            <div class="flex flex-col items-center">
                <p class="mb-2 font-serif text-sm tracking-widest">
                    Telah ditandatangani secara elektronik
                </p>
                <img src="{{ asset('assets/qrcode.png') }}" alt="" class="h-16 w-16 opacity-80" />
                <div class="border-cert-navy mb-2 w-40 border-t-2"></div>
                <p class="font-serif text-sm">IWAN PAHLEVI</p>
            </div>
        </div>

        <div class="decorative-band bottom-0" data-purpose="footer-graphics">
            <svg class="absolute bottom-0 left-0 h-full w-full" preserveAspectRatio="none" viewBox="0 0 800 100">
                <path d="M0 100 H800 V40 Q600 10 400 60 Q200 110 0 30 Z" fill="#1a365d"></path>
                <path d="M0 100 H800 V60 Q600 30 400 80 Q200 130 0 50 Z" fill="#c5a059" opacity="0.2"></path>
            </svg>
            <div
                class="bg-cert-gold absolute bottom-1/2 left-1/2 z-20 h-14 w-14 -translate-x-1/2 translate-y-1/2 rotate-45 transform border-4 border-white shadow-lg">
            </div>
        </div>
    </main>
</body>
