...
<body class="font-newsreader print-a4 bg-background mx-auto my-[25mm] box-border max-h-[297mm] w-[210mm] text-[10pt] text-black shadow-[0_0_10px_rgba(0,0,0,0.2)]">
    <div id="capture-area"
    ...
    <div class="top-20 flex justify-between">
        <div class="align-center flex w-full justify-between">
            ...
            <div class="flex items-end">
                <img src="{{ asset('assets/cover/Tashdiq.jpg') }}"
                     alt=""
                     class="w-[70px]" />
            </div>
        </div>
