...
<body class="font-inter print-a4 bg-surface-container-low architectural-shadow relative mx-auto my-[25mm] box-border max-h-[297mm] w-[210mm] text-[10pt] text-black">
    <div id="capture-area"
