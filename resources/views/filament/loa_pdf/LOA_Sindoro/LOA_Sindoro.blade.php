...
<body class="font-epilogue print-a4 bg-background mx-auto my-[25mm] box-border max-h-[297mm] w-[210mm] text-[10pt] text-black shadow-[0_0_10px_rgba(0,0,0,0.2)]">
    <div id="capture-area"
    ...
    <div class="flex justify-between">
        ...
        <h1 class="text-shadow-lg font-epilogue z-10 text-[20pt] font-[1000] leading-none text-black">
            LETTER
            <br />
