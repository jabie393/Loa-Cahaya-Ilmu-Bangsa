    ...
    <div class="container">
        ...
        <div class="content">
            <div class="intro">
                ...
                <h2>Hasil Evaluasi Awal Naskah Jurnal {{ $review->journal ? '"' . $review->journal->name . '"' : '' }}
                </h2>
            </div>
            ...
            <p style="font-size: 14px; color: #4b5563; margin-bottom: 25px;">Terima kasih telah menggunakan layanan
                penelaahan awal kami. Tim editorial telah selesai melakukan review singkat terhadap naskah Anda untuk
                memastikan kesesuaian standar sebelum diajukan ke sistem OJS.</p>
