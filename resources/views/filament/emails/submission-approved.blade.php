    ...
    <div style="max-width: 600px; margin: 20px auto; padding: 30px; background-color: #fff; border: 1px solid #e5e7eb; border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
        ...
        <div style="background-color: #f9fafb; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
            <table role="presentation" style="width: 100%; border-collapse: collapse; border-spacing: 0;">
                ...
                <tr>
                    <td style="padding: 8px 0; vertical-align: top; font-weight: 600; color: #1f2937;">Tanggal LOA:</td>
                    <td style="padding: 8px 0; color: #4b5563;">{{ $submission->date_of_loa->format('d M Y') }}</td>
                </tr>
                <tr>
                    <td style="padding: 8px 0; vertical-align: top; font-weight: 600; color: #1f2937;">Tanggal Disetujui:</td>
                    <td style="padding: 8px 0; color: #4b5563;">{{ $submission->approved_date->format('d M Y') }}</td>
                </tr>
            </table>
        </div>
